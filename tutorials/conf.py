# -*- coding: utf-8 -*-
#
# Kytos Project documentation build configuration file, created by
...
project = u'Tutorials'
copyright = u'2016-2020 Kytos Project'
...
latex_documents = [
    (master_doc, 'kytos.tex', u'python-openflow library Documentation',
...
man_pages = [
    (master_doc, 'kytos', u'python-openflow library Documentation',
     [author], 1)
]
